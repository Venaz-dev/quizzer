        ...
        <div className="content-holder">
          <div className="menu-section">
            ...
            <div className="dash-menu">
                ...
                <Link to= "/create-quiz" className="w3-bar-item dash-menu-item hover-animation">
                  Create Quiz
                </Link>
              
              <Link className="w3-bar-item dash-menu-item hover-animation">
                Quiz Results
              </Link>
            </div>
          </div>
          <div className="search-area">
            {this.state.isLoading === true ? (
              <div className="input-holder load-center">
                <i
                  className="fa fa-spinner w3-center w3-spin "
                  style={{ fontSize: "44px" }}
                />
              </div>
            ) : (
